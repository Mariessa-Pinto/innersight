            ...
            <ScrollView>
                <View style={[globalStyles.contentContainer, { backgroundColor: theme.background }]}>
                    ...
                    <View style={styles.maincontent}>
                        <Text style={globalStyles.bodyCopy}>We leverage intelligence (AI) technology to enhance your mental health journey. Our AI algorithms analyze journal entries, extracting valuable insights to provide personalized and constructive feedback. This process is designed to assist you in understanding patterns, managing stress, and fostering emotional well-being.</Text>
                        <Text style={globalStyles.bodyCopy}>The AI in InnerSight continually learns and evolves based on user interactions, allowing for increasingly refined and tailored suggestions over time. It respects the sensitivity of the information shared, prioritizing user privacy through stringent anonymization measures.
                        ...
                        <Text style={globalStyles.bodyCopy}>Our dedication to innovation is grounded in the belief that, together with AI, we can create a more empathetic and responsive space for mental health support within InnerSight.</Text>
                    </View>
                </View>
            </ScrollView>
